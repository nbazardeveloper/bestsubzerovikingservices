...
export const Route = createFileRoute("/services/$slug")({
  ...
  notFoundComponent: () => (
    <div className="mx-auto max-w-2xl px-4 py-24 text-center">
      ...
      <p className="mt-3 text-muted-foreground">This service page doesn't exist or has been removed.</p>
      <Link to="/services" className="mt-6 inline-flex text-accent hover:underline">Back to services</Link>
    </div>
  ),
  errorComponent: () => (
    <div className="mx-auto max-w-2xl px-4 py-24 text-center">
...
function ServiceDetail() {
  ...
  const { data: service } = useQuery({ queryKey: ["service", slug], queryFn: () => getServiceBySlug({ data: { slug } }) });
    ...
    <div>
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-8">
          ...
          <div className="mt-6 grid gap-10 md:grid-cols-2">
            <div>
              <span className="text-xs uppercase tracking-[0.2em] text-accent">{service.category}</span>
      ...
      <section className="border-y border-border bg-muted/30">
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-8">
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">Areas we <span className="text-accent">cover</span></h2>
      ...
      {related.length > 0 ? (
        <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">Related <span className="text-accent">services</span></h2>
